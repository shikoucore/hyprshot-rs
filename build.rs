...
fn main() {
    ...
    if target_os == "windows" {
        println!("cargo:rerun-if-changed=resources/windows/hyprshot.rc");
        println!("cargo:rerun-if-changed=resources/windows/hyprshot.manifest");
        #[cfg(target_os = "windows")]
        embed_resource::compile("resources/windows/hyprshot.rc", embed_resource::NONE);

        let out_dir = PathBuf::from(env::var("OUT_DIR").unwrap());
        let embed_file = out_dir.join("embedded_slurp.rs");
        let embed_code = r#"// Auto-generated by build.rs
// Embedded slurp not available on Windows.
